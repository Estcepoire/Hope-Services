...
export default function AnnouncementForm({ materialTypes }) {
    ...
    return (
        <main className="flex flex-row py-9">
            <section className="basis-1/2 p-7 mx-4">
                <h5 className=" text-lg">OBTENEZ LE MEILLEUR PRIX POUR VOTRE PLASTIQUE EN VRAC - 3 TONNES ET PLUS</h5>
                <h1 className="my-7 text-4xl"><b>Vendez vos déchets</b></h1>
                <p>Avec Hope Services, il est plus facile que jamais de vendre des déchets aux meilleurs prix aux entreprises de retraitement les plus durables.</p>
                <div className="mt-10 flex flex-row">
                    <div className="basis-1/2">
                        <ul className="list-none">
                            <li className="my-7"><span className="border-2 border-neutral-300 rounded-full p-2"><i className="bi bi-lock text-xl"></i></span> <b className="ml-2 text-2xl">SECURISE</b></li>
                            <li className="my-7"><span className="border-2 border-neutral-300 rounded-full p-2"><i className="bi bi-lock text-xl"></i></span> <b className="ml-2 text-2xl">SECURISE</b></li>
                            <li className="my-7"><span className="border-2 border-neutral-300 rounded-full p-2"><i className="bi bi-lock text-xl"></i></span> <b className="ml-2 text-2xl">SECURISE</b></li>
                        </ul>
                    </div>
            ...
            <form className="basis-1/2 px-10 py-8 mx-4" onSubmit={submit}>
                <div className="space-y-6">
                    <div className="mt-2">
                        ...
                        <select
                            id="materialType"
                            name="materialTypeId"
                            className="block w-full rounded-md border-0 py-4 mt-2 text-gray-900 shadow-sm ring-1 ring-inset ring-stone-950 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            onChange={(e) => { setData("materialTypeId", e.target.value);  fetchMaterialGroups(e.target.value)}}
                        >
                            <option value="-1">Veuillez selectionner...</option>
